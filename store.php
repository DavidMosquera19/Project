...
<head>
  ...
  <link rel="stylesheet" href="css/estilos2-2.css">
  <!-- Bootstrap CSS -->
    ...
    while ($file = mysqli_fetch_array($result)) {
      ...
      <div class="col-4 col-md-4 col-lg-4">
        <div class="card" style="background: rgba(0, 0, 0, 0.5);">
          <img src="<?php echo $file['img'] ?>" class="card-img" alt="...">
          <div class="card-body">
            <center>
              <h5 class="card-title">Nitro Tech</h5>
            </center>
            <center>
              <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Vero, laborum quam, nostrum deleniti esse!</p>
            </center>
            <center>
              <div class="container">
                    ...
                    <div class="modal-content">
                      <form action="compra.php" method="post">
                        <div class="modal-header">
                          <h4 class="modal-title" id="exampleModalLabel">confirmar</h5>
